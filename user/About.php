    ...
    <div class="container" data-aos="fade-up" style="margin-top: 5%">
        ...
        <div class="row">
            <div class="col-lg-6 order-1 order-lg-2" data-aos="zoom-in" data-aos-delay="100">
                <div class="about-img">
                    <img src="../assets/img/aboutt.jpg" alt="">
                </div>
            </div>
            <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
                ...
                <br>
                <p class="fst-italic" >
                    Our purpose is simple and bold. We exist to redefine how Indian restaurants taste, feel, and look. Our founding values consist ofproviding clean and heart-warming
                    food prepared with ethical practices with a hugeimportance on our team members and ourguests.
                </p>
                <ul>
                    <li><i class="bi bi-check-circle"></i>
                        We believe the happiness that comesfrom feeding souls is worth sharing.
                    </li>
                    <li><i class="bi bi-check-circle"></i>
                        We strive to positively impact the communities we live in and constantly practice our values.
                    </li>
                    <li><i class="bi bi-check-circle"></i>
                        It is our pleasure to serve you.Be brave and try something new.
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="box" data-aos="zoom-in" data-aos-delay="100">
                    ...
                    <p>In a food restaurant, food plating is a central idea to keep guests happy as they experience your restaurant. People scan the taste before eating,
                        so our creative plating can enhance both the appearance and the flavor of the food.
                    </p>
                </div>
            </div>
            <div class="col-lg-4 mt-4 mt-lg-0">
                <div class="box" data-aos="zoom-in" data-aos-delay="200">
                    ...
                    <p>Our motto is to make the atmosphere friendly and as efficient as possible. The waiters are patiently and happily take your order and serve the meal in the estimated time.
                        A nice and lovely environment forces you to come back for another date.
                    </p>
                </div>
            </div>
            <div class="col-lg-4 mt-4 mt-lg-0">
                <div class="box" data-aos="zoom-in" data-aos-delay="300">
                    <span>03</span>
                    <h4> Fresh food</h4>
                    <p>Our food is made fresh every day with ingredients. We bring the best taste in our cooking to make your day happier and healthier.
                        No matter which season is going on but giving you extraordinary is a part of our service.
                    </p>
                </div>
            </div>
        </div>
