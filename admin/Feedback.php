...
<div class="wrapper">
    <header data-aos="fade-up" >
        ...
        <?php
        $sql_product_show = "SELECT * FROM feedback";
        $rs_product = mysqli_query($conn, $sql_product_show);
        ?>
        <?php
        if ($rs_product->num_rows > 0) {
        ?>
        <table  class=" table-responsive-lg center " border="1" style="width:80%" >
            <tr>
                <h2 style="text-align: center;font-size: -100% ; color:#D6D6D6;padding:10%">Feedback From Customers</h2>
                <th style="text-align:center;color: orange;width:20%">Name</th>
                <th style="text-align:center;color: orange">Email</th>
                <th style="text-align:center;color: orange">subject</th>
            ...
            ?>
                <tr>
                    <td style="text-align:center; color: #D6D6D6  "><?php echo $row_product['fname']; ?></td>
                    <td  style="text-align:center; color: #D6D6D6 "><?php echo $row_product['femail']; ?></td>
                    <td style="text-align:center; color: #D6D6D6  "><?php echo $row_product['fsubject']; ?></td>
                    <td style="text-align:center; color: #D6D6D6  "><?php echo $row_product['fmessage']; ?></td>
                    <td style="text-align:center; color: #D6D6D6 " ><a class="" href="DeleteFeedback.php?f=<?= $row_product['fid'] ?>">Delete</a>
                    </td>
                </tr>
                <?php
            }
                ...
                ?>
            <h2 style="text-align: center;font-size: -100% ; color:#D6D6D6;padding:20%">No feedback details.</h2>
            <?php
             }
            ?>
        </table>
